  ...
  public class CoxPHDriver extends Driver {
    ...
    public void computeImpl() {
      ...
      try {
        ...
        final DataInfo dinfo = new DataInfo(f, null, nResponses, true, TransformType.DEMEAN, TransformType.NONE, true, false, false, false, false, false, _parms.interactionSpec())
                .disableIntercept();
